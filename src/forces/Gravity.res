...
let gravityForceV = (~attractorMass, ~moverMass, ~attractor, ~mover, ~g=gU, ~threshold=?, ()) => {
  ...
  Vector.multf(~v=dir, ~s=gravityForceMag(~attractorMass, ~moverMass, ~r=distance, ~g, ()))
}

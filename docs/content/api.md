...
| `reducedMotion`               | `{ from: { [key: keyof React.CSSProperties]: any }, to: { [key: keyof React.CSSProperties]: any }` | Optional. The animation configuration to use if the end user prefers reduced motion.                                                                                                                                                                          |

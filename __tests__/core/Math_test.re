...
describe("Math", () => {
  describe("constrainf", () => {
    it(
      "should constrain a value above the range to the upper limit of the range",
      () => {
      Expect.(
    ...
    it(
      "should constrain a value below the range to the lower limit of the range",
      () => {
      Expect.(
  ...
  describe("remapf", () => {
    it(
      ...
      Expect.(
        expect(
          Math.remapf(~range=(0., 300.), ~domain=(0., 1.), ~value=150.),
        )
        |> toEqual(0.5)
      )
    );
    ...
    it("should handle ranges and domains with non-overlapping inputs", () =>
      Expect.(
        expect(
          Math.remapf(~range=(200., 300.), ~domain=(10., 15.), ~value=220.),
        )
        |> toEqual(11.)
      )
    );
    ...
    it("should extrapolate outside the input range", () =>
      Expect.(
        expect(
          Math.remapf(~range=(200., 300.), ~domain=(10., 15.), ~value=180.),
        )
        |> toEqual(9.)
      )
    );
  ...
  describe("normalizef", () => {
    it(
      ...
      () =>
      Expect.(
        expect(Math.normalizef(~range=(0., 300.), ~value=150.))
        |> toEqual(0.5)
      )
    );
    ...
    it("should extrapolate outside the input range", () =>
      Expect.(
        expect(Math.normalizef(~range=(200., 300.), ~value=150.))
        |> toEqual(-0.5)
      )
    );
    ...
    it("should handle a negative input range", () =>
      Expect.(
        expect(Math.normalizef(~range=((-200.), (-300.)), ~value=-250.))
        |> toEqual(0.5)
      )
    );
  });
